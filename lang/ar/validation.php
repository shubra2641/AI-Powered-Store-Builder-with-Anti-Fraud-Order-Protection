...
return [
    ...
    */
    ...
    'alpha_dash' => 'يجب أن يحتوي :attribute على أحرف وأرقام وشرطات وواصلات سفلية فقط.',
    ...
    'dimensions' => 'يجب أن يكون حقل :attribute ذو أبعاد صورة صالحة.',
    ...
    'max' => [
        'array' => 'يجب أن يحتوي حقل :attribute على :max عنصر أو أقل.',
        'file' => 'يجب أن يكون حجم حقل :attribute أكبر من :max كيلوبايت.',
        'numeric' => 'يجب أن يكون حقل :attribute أكبر من :max.',
        'string' => 'يجب أن يكون طول حقل :attribute أكبر من :max حرفًا.',
    ],
    ...
    'min' => [
        'array' => 'يجب أن يحتوي حقل :attribute على :min عنصر أو أكثر.',
        'file' => 'يجب أن يكون حجم حقل :attribute أكبر من :min كيلوبايت.',
        'numeric' => 'يجب أن يكون حقل :attribute أكبر من :min.',
        'string' => 'يجب أن يكون طول حقل :attribute أكبر من :min حرفًا.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'لقد ظهر حقل :attribute في تسريب بيانات. يرجى اختيار حقل :attribute مختلف.',
    ],
